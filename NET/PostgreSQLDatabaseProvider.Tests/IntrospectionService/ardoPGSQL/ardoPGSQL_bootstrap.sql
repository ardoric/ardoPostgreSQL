CREATE TABLE "IntrospecTbl%Machine%" (ID serial NOT NULL, DBTEXT varchar(255) NOT NULL, DBINTEGER int, DBLONGINTEGER bigint, DBDECIMAL decimal(28, 8), DBBOOLEAN boolean, DBDATETIME timestamp, DBBINARYDATA bytea, CONSTRAINT PK_IntrospectionTestTable PRIMARY KEY (ID));
