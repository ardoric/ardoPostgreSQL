...
public class DMLEntityActionsTests extends DMLTest {
    ...
    @TestDetails(Description="Validates that using the placeholder values defined for the GetEntity action we can execute a select statement", TestIssue="610147", Feature="Database Abstraction Layer", CreatedBy="mar")
    ...
    @IterativeTestCase(iteratorType=DMLTestsConfiguration.class)
    @TestDetails(Description="Validates that using the placeholder values defined for the GetEntityForUpdate action we can execute a select statement", TestIssue="610147", Feature="Database Abstraction Layer", CreatedBy="mar")
    ...
    private final void innerGetEntity(IDatabaseServices databaseServices, Map<SelectPlaceholder, String> getPlaceholders, boolean forUpdate) throws Exception {
        ...
        String sql = beforeStatement + "SELECT " + afterSelect + "ID " + beforeFrom + "FROM " + afterFrom + "DUMMY" + getMachineName() + " " + 
            beforeWhere + 
            "WHERE " + 
            afterWhere + 
        ...
        int returnedId = sqlExecutor.executeScalar(sql).<Integer>runtimeValue(TypeInformation.Integer).intValue();
        int expectedId = 1;
    ...
    @IterativeTestCase(iteratorType=DMLTestsConfiguration.class)
    @TestDetails(Description="Validates that using the placeholder values defined for the CreateEntity action we can execute an insert statement", TestIssue="610147", Feature="Database Abstraction Layer", CreatedBy="mar")
    public final void testCreateEntity(DatabaseProviderTestCase tc) throws outsystems.hubedition.extensibility.data.databaseobjects.InvalidDatabaseObjectIdentifierException, outsystems.hubedition.extensibility.data.introspectionservice.IntrospectionServiceException, SQLException {
        ...
        final RefParmHolder<String> insertSql = new RefParmHolder<String>(beforeStatement + "INSERT INTO DUMMY" + getMachineName() + " (VAL) " + beforeValuesKeyword + "VALUES (" + value.getVal() + ")" + afterStatement);
        final RefParmHolder<String> selectSql = new RefParmHolder<String>("SELECT VAL FROM DUMMY" + getMachineName() + " WHERE VAL = " + value.getVal());
        
        executeSQL(databaseServices, (IExecutionService service, ADOTransaction tran) -> {
            {
    ...
    @IterativeTestCase(iteratorType=DMLTestsConfiguration.class)
    @TestDetails(Description="Validates that using the placeholder values defined for the CreateEntity action we can execute an insert statement retrieving the inserted identifier", TestIssue="610147", Feature="Database Abstraction Layer", CreatedBy="mar")
    public final void testCreateEntityRetrievingId(DatabaseProviderTestCase tc) throws outsystems.hubedition.extensibility.data.databaseobjects.InvalidDatabaseObjectIdentifierException, outsystems.hubedition.extensibility.data.introspectionservice.IntrospectionServiceException, SQLException {
        ...
        final RefParmHolder<String> sql = new RefParmHolder<String>(beforeStatement + "INSERT INTO DUMMY" + getMachineName() + " (VAL) " + beforeValuesKeyword + "VALUES (" + value.getVal() + ")" + afterStatement);
    ...
    private final void validateInsertedValue(IExecutionService service, ADOTransaction tran, int expectedValue, int returnedId, String executedSql) throws ParseException, SQLException {
        String sql = "SELECT VAL FROM DUMMY" + getMachineName() + " WHERE ID = " + returnedId;
        {
    ...
    @IterativeTestCase(iteratorType=DMLTestsConfiguration.class)
    @TestDetails(Description="Validates that using the placeholder values defined for the UpdateEntity action we can execute an update statement", TestIssue="610147", Feature="Database Abstraction Layer", CreatedBy="mar")
    public final void testUpdateEntity(DatabaseProviderTestCase tc) throws outsystems.hubedition.extensibility.data.databaseobjects.InvalidDatabaseObjectIdentifierException, outsystems.hubedition.extensibility.data.introspectionservice.IntrospectionServiceException, SQLException {
        ...
        final RefParmHolderInteger value = new RefParmHolderInteger(2);
        final RefParmHolder<String> updateSql = new RefParmHolder<String>(beforeStatement + "UPDATE DUMMY" + getMachineName() + " SET VAL = " + value.getVal() + " " + beforeWhereKeyword + "WHERE ID = 1" + afterStatement);
        final RefParmHolder<String> selectSql = new RefParmHolder<String>("SELECT VAL FROM DUMMY" + getMachineName() + " WHERE ID = 1");
    ...
    @IterativeTestCase(iteratorType=DMLTestsConfiguration.class)
    @TestDetails(Description="Validates that using the placeholder values defined for the DeleteEntity action we can execute a delete statement", TestIssue="610147", Feature="Database Abstraction Layer", CreatedBy="mar")
    public final void testDeleteEntity(DatabaseProviderTestCase tc) throws outsystems.hubedition.extensibility.data.databaseobjects.InvalidDatabaseObjectIdentifierException, outsystems.hubedition.extensibility.data.introspectionservice.IntrospectionServiceException, SQLException {
        ...
        final RefParmHolder<String> deleteSql = new RefParmHolder<String>(beforeStatement + "DELETE FROM DUMMY" + getMachineName() + " " + beforeWhereKeyword + "WHERE ID = 1" + afterStatement);
        final RefParmHolder<String> selectSql = new RefParmHolder<String>("SELECT VAL FROM DUMMY" + getMachineName() + " WHERE ID = 1");
    ...
    private final void executeSQL(IDatabaseServices services, Func.Func2_Lambda<IExecutionService, ADOTransaction, Object> execute) throws SQLException {
        {
