...
public abstract class BaseDatabaseProviderTestConfiguration<TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> implements IDatabaseProviderTestConfiguration<TDatabaseProvider>, IGenericObject {
    ...
    private static class ConfigurationLoader<TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> implements IGenericObject {
        ...
        private final IRuntimeDatabaseConfiguration loadConfiguration(String filepath) throws IOException, javax.xml.stream.XMLStreamException {
        ...
        public final IRuntimeDatabaseConfiguration load(String configFileSuffix) throws IOException, javax.xml.stream.XMLStreamException {
    ...
    protected static class TestSettings<TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> implements IGenericObject {
        ...
        public static <TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> String get(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, final TypeInformation<TDatabaseProviderTestCase> classTypeArg_TDatabaseProviderTestCase, String settingKey) throws FileNotFoundException, IOException {
    ...
    private static final String DEFAULT_CONFIGURATION_FILES_SETTING = "DatabaseProviderTests.DefaultConfigurationFilesPath";
    ...
    private final Iterable<IDatabaseProviderTestCase<TDatabaseProvider>> loadTestCasesFor(TDatabaseProvider provider) throws FileNotFoundException, IOException, javax.xml.stream.XMLStreamException {
                ...
                return new Yielder<IDatabaseProviderTestCase<TDatabaseProvider>>() {
                    ...
                    protected boolean advance() throws Exception
                    {
                        switch (currentStatement) {
                            case BEGIN:
                                configs = LinqMethods.toList(BaseDatabaseProviderTestConfiguration.<TDatabaseProvider, TDatabaseProviderTestCase>configurationsFor(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, provider));
                                ...
                                while (skipLoopCondition || (configIter.hasNext())) {
                                    ...
                                    switch (currentStatement) {
                                        default:
                                            ...
                                            testCase.setName( StringUtils.replace(provider.getProperties().getDisplayName(), " / ", "_") + " with conf " + config.getName() );
                                            ...
                                            testCase.setBootstrapScripts( BaseDatabaseProviderTestConfiguration.<TDatabaseProvider, TDatabaseProviderTestCase>processScripts(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, script.getBootstrap(), config.getRun()) );
                                            testCase.setTeardownScripts( BaseDatabaseProviderTestConfiguration.<TDatabaseProvider, TDatabaseProviderTestCase>processScripts(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, script.getTeardown(), config.getRun()) );
    ...
    private final TestCaseScripts<TDatabaseProvider, TDatabaseProviderTestCase> scriptsFor(TDatabaseProvider provider) throws FileNotFoundException, IOException {
        ...
        final RefParmHolder<String> defaultScriptsDir = new RefParmHolder<String>(FileUtils.combine(getDefaultConfigurationDirectory(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase), pluginKey));
        
        Func.Func1_Lambda<String, Iterable<String>> tryLoadScripts = (String scriptFileSuffix) -> {
            ...
            if (scripts == null && FileUtils.directoryExists(defaultScriptsDir.getVal()))
            {
                scripts = loader.load(defaultScriptsDir.getVal());
            }
            return scripts;
        };
    ...
    protected final String getTestConfigurationDirectory() throws FileNotFoundException, IOException
    {
        return TestSettings.<TDatabaseProvider, TDatabaseProviderTestCase>get(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, getConfigurationPathSettingName());
    }
    ...
    public final Iterable<IDatabaseProviderTestCase<TDatabaseProvider>> getTestCases()
    {
        ...
        {
            result.setVal(LinqMethods.toList(LinqMethods.selectMany(getProvidersToTest(), (TDatabaseProvider p) -> {
    ...
    private static <TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> Iterable<TestCaseConfiguration<TDatabaseProvider, TDatabaseProviderTestCase>> configurationsFor(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, final TypeInformation<TDatabaseProviderTestCase> classTypeArg_TDatabaseProviderTestCase, TDatabaseProvider provider) throws FileNotFoundException, IOException, javax.xml.stream.XMLStreamException {
        ...
        else
        {
            ...
            {
                configurationsPath = FileUtils.combine(getDefaultConfigurationDirectory(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase), providerKey);
            }
    ...
    private static <TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> String getBaseConfigurationDirectory(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, final TypeInformation<TDatabaseProviderTestCase> classTypeArg_TDatabaseProviderTestCase) throws FileNotFoundException, IOException
    {
        staticInitBaseDatabaseProviderTestConfiguration(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase);
        return TestSettings.<TDatabaseProvider, TDatabaseProviderTestCase>get(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, BASE_CONFIGURATION_FILES_SETTING);
    }
    
    private static <TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> String getDefaultConfigurationDirectory(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, final TypeInformation<TDatabaseProviderTestCase> classTypeArg_TDatabaseProviderTestCase) throws FileNotFoundException, IOException
    {
        staticInitBaseDatabaseProviderTestConfiguration(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase);
        return TestSettings.<TDatabaseProvider, TDatabaseProviderTestCase>get(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, DEFAULT_CONFIGURATION_FILES_SETTING);
    }
    ...
    private static <TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> Iterable<String> processScripts(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, final TypeInformation<TDatabaseProviderTestCase> classTypeArg_TDatabaseProviderTestCase, Iterable<String> scripts, final IRuntimeDatabaseConfiguration config) {
        staticInitBaseDatabaseProviderTestConfiguration(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase);
        return LinqMethods.select(scripts, (String script) -> {
            return BaseDatabaseProviderTestConfiguration.<TDatabaseProvider, TDatabaseProviderTestCase>replace(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, script, getConfigParamRegexField(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase), (Match m) -> {
                return BaseDatabaseProviderTestConfiguration.<TDatabaseProvider, TDatabaseProviderTestCase>processScript(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, m, config);
            });
        });
    }
    ...
    private static <TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> String processScript(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, final TypeInformation<TDatabaseProviderTestCase> classTypeArg_TDatabaseProviderTestCase, Match match, IRuntimeDatabaseConfiguration config) throws Exception {
        ...
        if (StringUtils.equals(configParamName, "Machine"))
        {
            return BaseDatabaseProviderTest.getMachineName();
        }
    ...
    private static <TDatabaseProvider extends IDatabaseProvider, TDatabaseProviderTestCase extends IDatabaseProviderTestCase<TDatabaseProvider>> String replace(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, final TypeInformation<TDatabaseProviderTestCase> classTypeArg_TDatabaseProviderTestCase, String sql, Pattern regex, MatchEvaluator_Lambda matchEval) {
        ...
        for( int i = 0; i < mc.size(); i++)
        {
            ...
            sql = BaseDatabaseProviderTestConfiguration.<TDatabaseProvider, TDatabaseProviderTestCase>replaceSpan(classTypeArg_TDatabaseProvider, classTypeArg_TDatabaseProviderTestCase, sql, mc.get(i).start() + fixup, mc.get(i).length(), s);
