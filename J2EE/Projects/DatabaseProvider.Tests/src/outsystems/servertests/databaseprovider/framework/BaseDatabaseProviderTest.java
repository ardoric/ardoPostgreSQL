...
public abstract class BaseDatabaseProviderTest extends DashboardTest {
    ...
    public abstract static class BaseDatabaseProviderTestCase<TDatabaseProvider extends IDatabaseProvider, TDatabaseServices extends IDatabaseServices> implements IDatabaseProviderTestCase<TDatabaseProvider>, IGenericObject {
        ...
        try {
            ...
            {
                Exception bootstrapException = (Exception)exceptionToHandle1;
                try {
                    executeTeardown();
                }catch (Exception exceptionToHandle2) {
                    exceptionToHandle2 = WrappedException.unwrapExceptionIfNeeded(exceptionToHandle2);
                    
                    {
                        Exception teardownException = (Exception)exceptionToHandle2;
    ...
    public abstract void initializeServices(TDatabaseProvider provider, IRuntimeDatabaseConfiguration runtimeConfiguration, IRuntimeDatabaseConfiguration bootstrapConfiguration, boolean runWithBootstrapServices);
...
protected static class SQLExecutor {
    ...
    public final Scalar executeScalar(String sql, Func.Func2_Lambda<Integer, Class<?>, String> getParamName, Object ... parameters) throws Exception {
        final RefParmHolder<IExecutionService> executionService = new RefParmHolder<IExecutionService>(services.getExecutionService());
        Object value = executeInTransactionAndRollback(sql, (ADOCommand cmd) -> {
    ...
    public final Object executeNonQueryWithoutTransaction(String sql, Object ... parameters) throws Exception {
        final RefParmHolder<IExecutionService> executionService = new RefParmHolder<IExecutionService>(services.getExecutionService());
        return executeInConnection(sql, (ADOCommand cmd) -> {
    ...
    public final Object executeNonQuery(String sql, Object ... parameters) throws Exception {
        final RefParmHolder<IExecutionService> executionService = new RefParmHolder<IExecutionService>(services.getExecutionService());
        return executeInTransactionAndCommit(sql, (ADOCommand cmd) -> {
            return Integer.valueOf(executionService.getVal().executeNonQuery(cmd));
        }, 
            new Func.Func2<Integer, Class<?>, String>() {
                protected String executeImpl(Integer arg1, Class<?> arg2) throws Exception {
    ...
    public final void executeReader(String sql, final Action.Action1_Lambda<OSResultSet> action, Object ... parameters) throws Exception {
        final RefParmHolder<IExecutionService> executionService = new RefParmHolder<IExecutionService>(services.getExecutionService());
        executeInTransactionAndRollback(sql, (ADOCommand cmd) -> {
            {
    ...
    private final Object executeWithCommand(String sql, Func.Func1_Lambda<ADOCommand, Object> action, Action.Action1_Lambda<ADOTransaction> applyTrans, Func.Func2_Lambda<Integer, Class<?>, String> getParamName, Object ... parameters) throws Exception {
        try {
            {
    ...
    private final Object executeInTransactionAndCommit(String sql, Func.Func1_Lambda<ADOCommand, Object> action, Func.Func2_Lambda<Integer, Class<?>, String> getParamName, Object ... parameters) throws Exception {
        return executeWithCommand(sql, action, (ADOTransaction trans) -> {
            trans.commit();
        }, getParamName, parameters);
    }
    
    private final Object executeInTransactionAndRollback(String sql, Func.Func1_Lambda<ADOCommand, Object> action, Func.Func2_Lambda<Integer, Class<?>, String> getParamName, Object ... parameters) throws Exception {
        return executeWithCommand(sql, action, (ADOTransaction trans) -> {
            trans.rollback();
        }, getParamName, parameters);
    }
    
    private final Object executeInConnection(String sql, Func.Func1_Lambda<ADOCommand, Object> action, Func.Func2_Lambda<Integer, Class<?>, String> getParamName, Object ... parameters) throws Exception {
...
protected static class Scalar {
    ...
    public final <V> V value(final TypeInformation<V> methodTypeArg_V) throws Exception {
        return this.<V>cast(methodTypeArg_V, value());
    }
    
    public final <V> V runtimeValue(final TypeInformation<V> methodTypeArg_V) throws Exception {
        return this.<V>cast(methodTypeArg_V, runtimeValue());
    }
...
{
    if (StringUtils.equals(_machineName, null))
    {
        String machine = Environment.getMachineName().toUpperCase(java.util.Locale.ROOT);
        
        // Reduce machine name length to avoid long oracle identifiers
        machine = Pattern.compile("^(RE?G?|VM)").matcher(machine).replaceAll("");
        machine = Pattern.compile("0|-").matcher(machine).replaceAll("");
        _machineName = StringUtils.substring(machine, 0, Math.min(8, machine.length()));
    }
