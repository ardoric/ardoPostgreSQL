...
public class DMLDefaultValuesTests extends DMLTest {
    ...
    private final <T> void assertValue(final TypeInformation<T> methodTypeArg_T, IDatabaseServices services, String defaultValueName, String defaultValue, Object expectedValue) throws Exception {
        ...
        Object result = sqlExecutor.executeScalar(sql).runtimeValue(methodTypeArg_T);
    ...
    public final void testIntegerDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        ...
        assertValue(TypeInformation.Integer, databaseServices, "Integer", databaseServices.getDMLService().getDefaultValues().getInteger(), Integer.valueOf(0));
    }
    ...
    public final void testDecimalDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        IDatabaseServices databaseServices = tc.getServices();
        assertValue(TypeInformation.BigDecimal, databaseServices, "Decimal", databaseServices.getDMLService().getDefaultValues().getDecimal(), BigDecimal.valueOf(0));
    }
    ...
    public final void testBooleanDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        IDatabaseServices databaseServices = tc.getServices();
        assertValue(TypeInformation.Boolean, databaseServices, "Boolean", databaseServices.getDMLService().getDefaultValues().getBoolean(), Boolean.valueOf(false));
    }
    ...
    public final void testTextDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        IDatabaseServices databaseServices = tc.getServices();
        assertValue(TypeInformation.String, databaseServices, "Text", databaseServices.getDMLService().getDefaultValues().getText(), "");
    }
    ...
    public final void testDateDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        IDatabaseServices databaseServices = tc.getServices();
        assertValue(TypeInformation.get(DateTime.class), databaseServices, "Date", databaseServices.getDMLService().getDefaultValues().getDate(), new DateTime(1900, 1, 1, 0, 0, 0));
    }
    ...
    public final void testTimeDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        IDatabaseServices databaseServices = tc.getServices();
        assertValue(TypeInformation.get(DateTime.class), databaseServices, "Time", databaseServices.getDMLService().getDefaultValues().getTime(), new DateTime(1900, 1, 1, 0, 0, 0));
    }
    ...
    public final void testDateTimeDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        IDatabaseServices databaseServices = tc.getServices();
        assertValue(TypeInformation.get(DateTime.class), databaseServices, "DateTime", databaseServices.getDMLService().getDefaultValues().getDateTime(), new DateTime(1900, 1, 1, 0, 0, 0));
    }
    ...
    public final void testBinaryDataDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        ...
        String sql = "SELECT " + dmlDefaultValues.getBinaryData() + " o1 FROM DUMMY";
        byte[] result = sqlExecutor.executeScalar(sql).runtimeValue(TypeInformation.get(byte[].class));
    ...
    public final void testNullDefaultValue(DatabaseProviderTestCase tc) throws Exception {
        IDatabaseServices databaseServices = tc.getServices();
        assertValue(TypeInformation.Object, databaseServices, "Null", databaseServices.getDMLService().getDefaultValues().getNull(), null);
    }
