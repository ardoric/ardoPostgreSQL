...
public class BaseDatabaseConfigurationTests extends DashboardTest {
    ...
    public static class MockDatabaseConfiguration extends BaseDatabaseConfiguration {
        ...
        public String getDatabaseIdentifier() throws UnsupportedOperationException
        {
            throw new UnsupportedOperationException();
        }
        ...
        protected String assembleAdvancedConnectionString() throws UnsupportedOperationException {
            throw new UnsupportedOperationException();
        }
