...
public class MetaDatabaseConfigurationTests extends DashboardTest {
    ...
    public final void annotatedParametersAreDiscovered() {
        ...
        ArrayList<String> obtainedParameters = LinqMethods.toList(LinqMethods.select(wrapper.getVisibleParameters(), 
            new Func.Func1<IUserDefinedParameter, String>() {
                protected String executeImpl(IUserDefinedParameter p) throws Exception
                {
                    return p.getName();
                }
            }));
    ...
    public final void nonUserDefinedParametersAreDiscovered() {
        ...
        ArrayList<String> obtainedParameters = LinqMethods.toList(LinqMethods.select(LinqMethods.where(wrapper.getParameters(), 
            ...
            new Func.Func1<IParameter, String>() {
                protected String executeImpl(IParameter p) throws Exception
                {
                    return p.getName();
                }
            }));
