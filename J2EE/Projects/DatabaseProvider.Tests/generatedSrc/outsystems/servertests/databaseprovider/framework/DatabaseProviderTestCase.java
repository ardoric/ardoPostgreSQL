...
public class DatabaseProviderTestCase extends BaseDatabaseProviderTest.BaseDatabaseProviderTestCase<IDatabaseProvider, IDatabaseServices> {
    ...
    public void initializeServices(IDatabaseProvider provider, IRuntimeDatabaseConfiguration runtimeConfiguration, IRuntimeDatabaseConfiguration bootstrapConfiguration, boolean runWithBootstrapServices) throws UnsupportedOperationException {
