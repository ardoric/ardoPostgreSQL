...
public final class Serializer<TConfiguration> implements IGenericObject {
    private Func.Func1<String, String> _valueEncrypter;
    
    public final Func.Func1<String, String> getValueEncrypter()
    {
        return _valueEncrypter;
    }
    
    public final void setValueEncrypter(Func.Func1<String, String> value)
    {
        _valueEncrypter = value;
    }
    
    private String tag;
    private Func.Func1<TConfiguration, Iterable<IParameter>> parameterExtractor;
    
    
    public Serializer(final TypeInformation<TConfiguration> classTypeArg_TConfiguration, String tag, Func.Func1<TConfiguration, Iterable<IParameter>> parameterExtractor){
    ...
    public final XElement serialize(TConfiguration conf) {
        ...
        CollectionsExtensions.apply(TypeInformation.get(XElement.class), LinqMethods.select(parameterExtractor.execute(conf),
                ...
                new Func.Func1<IParameter, XElement>() {
                    protected XElement executeImpl(IParameter p) throws Exception
                    {
