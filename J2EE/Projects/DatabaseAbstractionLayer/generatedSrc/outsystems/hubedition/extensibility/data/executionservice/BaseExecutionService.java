...
public abstract class BaseExecutionService implements IExecutionService {
	 ...
	 */
    public abstract boolean isConnectionException(SQLException e);
    ...
    public int executeNonQuery(ADOCommand cmd) throws SQLException {
        try {
            ...
            if (exceptionToHandle instanceof SQLException) {
                SQLException e = (SQLException)exceptionToHandle;
	 ...
	 *	@return	The parameter already associated to the comand.
	 */
    ...
    /**
     *	Checks if an exception was raised due to a timeout. This implementation checks if the exception is a SQLException, and its error code is -2.
