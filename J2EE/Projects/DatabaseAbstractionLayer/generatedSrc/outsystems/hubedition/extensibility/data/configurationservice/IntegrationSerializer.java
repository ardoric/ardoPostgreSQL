...
public final class IntegrationSerializer {
    ...
    public final String serialize(IIntegrationDatabaseConfiguration config) throws ConfigurationSerializationException {
        try {
            MetaDatabaseConfiguration wrapper = new MetaDatabaseConfiguration(config);
            
            Iterable<IParameter> parametersToSerialize = LinqMethods.union(LinqMethods.where(LinqMethods.cast(TypeInformation.get(IParameter.class), wrapper.getVisibleParameters()), 
                ...
                LinqMethods.where(wrapper.getParameters(), 
                    new Func.Func1<IParameter, Boolean>() {
                        protected Boolean executeImpl(IParameter p) throws Exception
                        {
