...
public final class Deserializer<TConfiguration> implements IGenericObject {
    private String _tag;
    private Func.Func1<String, String> _valueDecrypter;
    ...
    public final Func.Func1<String, String> getValueDecrypter()
    {
        return _valueDecrypter;
    }
    
    public final void setValueDecrypter(Func.Func1<String, String> value)
    {
    ...
    public final void deserialize(XElement xmlConf, TConfiguration conf) throws ConfigurationSerializationException {
