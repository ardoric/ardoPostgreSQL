...
public class Serializers {
    ...
    {
        Func.Func1<IPlatformDatabaseConfiguration, Iterable<IParameter>> e = 
            new Func.Func1<IPlatformDatabaseConfiguration, Iterable<IParameter>>() {
                protected Iterable<IParameter> executeImpl(IPlatformDatabaseConfiguration c) throws Exception
                {
                    MetaDatabaseConfiguration m = new MetaDatabaseConfiguration(c);
                    Iterable<IParameter> ps = LinqMethods.where(m.getParameters(), 
    ...
    {
        Func.Func1<ISessionDatabaseConfiguration, Iterable<IParameter>> e = 
            new Func.Func1<ISessionDatabaseConfiguration, Iterable<IParameter>>() {
                protected Iterable<IParameter> executeImpl(ISessionDatabaseConfiguration c) throws Exception
                {
                    MetaDatabaseConfiguration m = new MetaDatabaseConfiguration(c);
                    Iterable<IParameter> ps = LinqMethods.where(m.getParameters(), 
                        new Func.Func1<IParameter, Boolean>() {
