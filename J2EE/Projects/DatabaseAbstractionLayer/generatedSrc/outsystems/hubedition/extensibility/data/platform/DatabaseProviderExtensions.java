...
public class DatabaseProviderExtensions {
    ...
    public static <BaseType> BaseType getProviderSpecificType(final TypeInformation<BaseType> methodTypeArg_BaseType, IDatabaseProvider provider, Class<?> ... specificTypes) {
        try {
            ...
            
            {
                ...
                String message = "Error creating instance of '" + methodTypeArg_BaseType.getTypeClass().getSimpleName() + "' from types: " + CollectionsExtensions.strCat(LinqMethods.select(Arrays.asList(specificTypes), 
    new Func.Func1<Class<?>, String>() {
        protected String executeImpl(Class<?> t) throws Exception
        {
    ...
    /**
	 *	Creates an instance of a type that inherits from BaseType, from a list of possible  Types (specificTypes). If none is found, reurns an instance of BaseType.
	 *	@param	provider	Database provider used to filter the specificTypes
    ...
    public static <BaseType> BaseType getProviderSpecificOrBaseType(final TypeInformation<BaseType> methodTypeArg_BaseType, IDatabaseProvider provider, Class<?> ... specificTypes) {
        ...
        BaseType type = getProviderSpecificType(methodTypeArg_BaseType, provider, specificTypes);
