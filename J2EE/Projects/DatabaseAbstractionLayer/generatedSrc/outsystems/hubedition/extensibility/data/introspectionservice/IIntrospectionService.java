...
public interface IIntrospectionService
{
	 ...
	 *	@throws	SQLException	if an error occurs while accessing the database
	 */
    public Iterable<ITableSourceInfo> listTableSources(IDatabaseInfo database, IsTableSourceToIgnore isTableSourceToIgnore) throws IntrospectionServiceException, java.sql.SQLException;
