...
public interface IDMLService
{
	 ...
	 *	@return	An object that generates the SQL fragments required to perform entity actions
	 */
	 ...
	 *	@return	An object that generates the SQL operators required to execute simple queries.
	 */
	 ...
	 *	@return	An object that generates the SQL aggregate functions required to execute DataSet queries
	 */
	 ...
	 *	@return	An object that generates the SQL default values for each database type.
	 */
	 ...
	 *	@return	The syntax highlight definitions.
	 */
	 ...
	 *	@return	DML expression that transforms the value.
	 */
    public String transformValue(String value, DBDataType type);
