...
public abstract class BaseSessionDatabaseConfiguration implements ISessionDatabaseConfiguration, ISuggestionableConfiguration {
    ...
    private int _deleteExpiredSessionsAvoidLockRowCount;
    ...
    public final void setSessionAuthenticationCredential(PasswordAuthentication value)
    {
        setSessionUser( value.getUserName() );
        setSessionPassword( new String(value.getPassword()) );
    }
    ...
    protected static final int DEFAULT_DELETEEXPIREDSESSIONSROWCOUNT_VALUE = 100;
    
    @ConfigurationParameter
    public final int getDeleteExpiredSessionsAvoidLockRowCount()
    {
        return _deleteExpiredSessionsAvoidLockRowCount;
    }
    
    @ConfigurationParameter
    public final void setDeleteExpiredSessionsAvoidLockRowCount(int value)
    {
        _deleteExpiredSessionsAvoidLockRowCount = value;
    }
    
    public BaseSessionDatabaseConfiguration(){
        setDeleteExpiredSessionsAvoidLockRowCount( DEFAULT_DELETEEXPIREDSESSIONSROWCOUNT_VALUE );
    }
}
