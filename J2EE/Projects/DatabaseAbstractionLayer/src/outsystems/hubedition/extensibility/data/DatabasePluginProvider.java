...
public final class DatabasePluginProvider<TDatabaseProvider extends IDatabaseProvider> extends AbstractPluginProvider<DatabaseProviderKey, TDatabaseProvider> implements IDatabasePluginSet<TDatabaseProvider>, IGenericObject {
    ...
    private Iterable<File> pluginDirectories;
    protected Iterable<File> getPluginDirectories()
    {
    ...
    public DatabasePluginProvider(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, File plugins){
        this(classTypeArg_TDatabaseProvider, Arrays.asList(new File[] { plugins }));
    }
    
    public DatabasePluginProvider(final TypeInformation<TDatabaseProvider> classTypeArg_TDatabaseProvider, Iterable<File> plugins){
        ...
        loadPlugins((Throwable e, String s) -> {
            OSTrace.info(s, e);
        });
    }
