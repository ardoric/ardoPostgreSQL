...
public abstract class BaseDMLService implements IDMLService {
    ...
    /**
	 *	Returns an SQL expression that transforms a value of a specified type, to be used in conditions and calculated columns. This implementation returns the value without making any modification to it.
	 */
