...
public abstract class BasePlatformConfigurationManager extends BaseConfigurationManager implements IPlatformConfigurationManager {
    ...
    public boolean requiresElevatedPrivilges() {
        return uiConfiguration.isImplementsElevatedPrivilegesOperations();
    }
    
    public String generateSetupScript() {
        throw new UnsupportedOperationException("Setup script generation not implemented for this database provider");
    }
    ...
    public Version getUpgradeVersion() throws Exception {
        ...
        String version = LinqMethods.first(Block.TypeInfo, sliceModelScript(script, null), (Block b) -> {
