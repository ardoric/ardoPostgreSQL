...
public abstract class BaseQueryProvider<QueryProviderType, QueryProviderQualifier extends IQueryProviderQualifier> implements IGenericObject {
    ...
    private static class QueryProviderTypeInstanceHolder<QueryProviderType, QueryProviderQualifier extends IQueryProviderQualifier> {
        ...
        private static <QueryProviderType, QueryProviderQualifier extends IQueryProviderQualifier> QueryProviderType getInstanceField(final TypeInformation<QueryProviderType> classTypeArg_QueryProviderType, final TypeInformation<QueryProviderQualifier> classTypeArg_QueryProviderQualifier) {
            QueryProviderTypeInstanceHolderStaticsHandler<QueryProviderType, QueryProviderQualifier> staticsHandler = staticInitQueryProviderTypeInstanceHolder(classTypeArg_QueryProviderType, classTypeArg_QueryProviderQualifier);
        ...
        {
            staticInitQueryProviderTypeInstanceHolder(classTypeArg_QueryProviderType, classTypeArg_QueryProviderQualifier);
        ...
        protected static <QueryProviderType, QueryProviderQualifier extends IQueryProviderQualifier> QueryProviderTypeInstanceHolderStaticsHandler<QueryProviderType, QueryProviderQualifier> staticInitQueryProviderTypeInstanceHolder(final TypeInformation<QueryProviderType> classTypeArg_QueryProviderType, final TypeInformation<QueryProviderQualifier> classTypeArg_QueryProviderQualifier) {
            @SuppressWarnings("unchecked")
            QueryProviderTypeInstanceHolderStaticsHandler<QueryProviderType, QueryProviderQualifier> result = StaticsHandlerFactory.get(QueryProviderTypeInstanceHolderStaticsHandler.class, QueryProviderTypeInstanceHolderStaticsHandler.staticsHandlerMap, classTypeArg_QueryProviderType, classTypeArg_QueryProviderQualifier);
        ...
        private static final class QueryProviderTypeInstanceHolderStaticsHandler<QueryProviderType, QueryProviderQualifier extends IQueryProviderQualifier> extends StaticsHandler {
            @SuppressWarnings("rawtypes")
            public static final java.util.Map<TypeArguments, QueryProviderTypeInstanceHolderStaticsHandler> staticsHandlerMap = new java.util.HashMap<TypeArguments, QueryProviderTypeInstanceHolderStaticsHandler>();
	 ...
	 *	@return	The instance to execute the queries.
	 *	@param <QueryProviderQualifier> Class related to the provider's qualifier.
@param <QueryProviderType> Class related to the provider's type.
@param classTypeArg_QueryProviderType The information about the QueryProviderType's type.
@param classTypeArg_QueryProviderQualifier The information about the QueryProviderQualifier's type.
	 */
    public static <QueryProviderType, QueryProviderQualifier extends IQueryProviderQualifier> QueryProviderType getInstance(final TypeInformation<QueryProviderType> classTypeArg_QueryProviderType, final TypeInformation<QueryProviderQualifier> classTypeArg_QueryProviderQualifier)
    {
        ...
        return QueryProviderTypeInstanceHolder.getInstance(classTypeArg_QueryProviderType, classTypeArg_QueryProviderQualifier);
    }
