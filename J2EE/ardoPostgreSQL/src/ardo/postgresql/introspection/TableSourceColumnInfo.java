...
public class TableSourceColumnInfo implements ITableSourceColumnInfo {
    ...
    public static TableSourceColumnInfo create(ITableSourceInfo tableSource, ResultSet reader) throws SQLException {
    	...
    	boolean isPrimaryKey = !StringUtils.isNullOrEmpty(reader.getString("constraint_type")) && reader.getString("constraint_type").toUpperCase().equals("PRIMARY KEY");
    	
    	// correct potential inconsistencies
    	
    	if (isPrimaryKey && !(dataType.getType() == DBDataType.INTEGER || dataType.getType() == DBDataType.TEXT))
    	...
    	if (isAutoGenerated && !(dataType.getType() == DBDataType.INTEGER))
